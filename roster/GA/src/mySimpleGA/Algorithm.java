...
public class Algorithm {
	...
	public static Population evolvePopulation(Population pop) {
		final Population newPopulation = new Population(pop.size(), pop.getGeneSize(), false);
	...
	private static Individual crossover(Individual indiv1, Individual indiv2) {
		final Individual newSol = new Individual(indiv1.size());
		// Loop through genes
	...
	private static Individual tournamentSelection(Population pop) {
		...
		final Population tournament = new Population(Constants.DEFAULT_TOURNAMENT_SIZE, pop.getGeneSize(), false);
